      ...
      <form className="md:m-20   border-4 border-gray-200">
        <div className="md:m-10 sm:m-10 py-24 ">
          ...
          <p className="md:text-lg sm:text-sm px-3 text-justify">
            ...
            that they shared and/or collect in Kiyo. This policy is not
          ...
          <p className="md:text-lg sm:text-sm px-3 text-justify">
            Kiyo follows a standard procedure of using log files. These files
          ...
          <p className="md:text-lg sm:text-sm px-3 text-justify">
            Like any other website, Kiyo uses "cookies". These cookies are used
          ...
          <p className="md:text-lg sm:text-sm px-3 text-justify">
            ...
            advertising partners of Kiyo.
          </p>

          <p className="md:text-lg sm:text-sm px-3 text-justify">
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on Kiyo, which are
          ...
          <p className="md:text-lg sm:text-sm px-3 text-justify">
            Note that Kiyo has no access to or control over these cookies that
          ...
          <p className="md:text-lg sm:text-sm px-3 text-justify">
            Kiyo's Privacy Policy does not apply to other advertisers or
          ...
          <p className="md:text-lg sm:text-sm px-3 text-justify">
            Kiyo does not knowingly collect any Personal Identifiable
