    ...
    <div>
      ...
      <form className="md:m-20  2xl border-4 border-gray-200">
        <div className="md:m-10 sm:m-10 py-24">
          <h2 className="md:text-4xl text-center mb-10 sm:text-2xl font-bold px-2">
          ...
          <p className="md:text-lg sm:text-sm px-3 text-justify">
            ...
            use of Kiyo's Website, located at www.kiyo.com.
          </p>

          <p className="md:text-lg sm:text-sm px-3 text-justify">
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Kiyo if you do not agree to take
          ...
          <h3 className="md:text-3xl mb-2 mt-10 sm:text-lg font-semibold px-2">
            Cookies
          </h3>

          <p className="md:text-lg sm:text-sm px-3 text-justify">
            We employ the use of cookies. By accessing Kiyo, you agreed to use
            cookies in agreement with the Kiyo's Privacy Policy.{" "}
          </p>
          ...
          <p className="md:text-lg sm:text-sm px-3 text-justify">
            Unless otherwise stated, Kiyo and/or its licensors own the
            intellectual property rights for all material on Kiyo. All
            intellectual property rights are reserved. You may access this from
            Kiyo for your own personal use subjected to restrictions set in
          ...
          <ul className="md:text-lg list-disc ml-10 mt-2 sm:text-sm">
            <li>Republish material from Kiyo</li>
            <li>Sell, rent or sub-license material from Kiyo</li>
            <li>Reproduce, duplicate or copy material from Kiyo</li>
            <li>Redistribute content from Kiyo</li>
          </ul>
          ...
          <p className="md:text-lg sm:text-sm px-3 text-justify">
            ...
            Kiyo does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of Kiyo,its agents and/or affiliates. Comments reflect the
            views and opinions of the person who post their views and opinions.
            To the extent permitted by applicable laws, Kiyo shall not be liable
          ...
          <p className="md:text-lg sm:text-sm px-3 text-justify">
            Kiyo reserves the right to monitor all Comments and to remove any
          ...
          <p className="md:text-lg sm:text-sm px-3 text-justify">
            You hereby grant Kiyo a non-exclusive license to use, reproduce,
          ...
          <p className="md:text-lg sm:text-sm px-3 text-justify">
            ...
            visibility of the hyperlink compensates the absence of Kiyo; and (d)
          ...
          <p className="md:text-lg sm:text-sm px-3 text-justify">
            ...
            sending an e-mail to Kiyo. Please include your name, your
          ...
          <p className="md:text-lg sm:text-sm px-3 text-justify">
            No use of Kiyo's logo or other artwork will be allowed for linking
